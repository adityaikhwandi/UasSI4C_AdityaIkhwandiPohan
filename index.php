...
// Query untuk mengambil jumlah rekam medis
$sql_rekam_medis = "SELECT COUNT(*) AS total_rekam_medis FROM rekam_medis";
$result_rekam_medis = $conn->query($sql_rekam_medis);
$row_rekam_medis = $result_rekam_medis->fetch_assoc();
$total_rekam_medis = $row_rekam_medis['total_rekam_medis'];

// Query untuk mengambil jumlah obat
$sql_obat = "SELECT COUNT(*) AS total_obat FROM obat";
$result_obat = $conn->query($sql_obat);
$row_obat = $result_obat->fetch_assoc();
$total_obat = $row_obat['total_obat'];
